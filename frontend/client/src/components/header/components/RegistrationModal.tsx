...
const RegistrationModal = React.forwardRef<HTMLDivElement, RegistrationModalProps>(({
    show,
    onClose,
    registrationForm,
    showPassword,
            ...
            <Modal.Body className={styles.modalBody}>
                ...
                {registrationStep === 1 ? (
                    ...
                    <Form onSubmit={handleSubmit} className={styles.formContainer}>
                        ...
                        {/* Согласие с условиями эксплуатации */}
                        <Form.Group className={styles.checkboxGroup}>
                            <label className={styles.checkboxLabel}>
                                <input
                                    type="checkbox"
                                    name="agreeToTerms"
                                    checked={registrationForm.agreeToTerms || false}
                                    onChange={onInputChange}
                                    className={styles.checkbox}
                                />
                                <span className={styles.checkboxText}>
                                    Я принимаю условия пользовательского соглашения <span className={styles.requiredStar}>*</span>
                                </span>
                            </label>
                            <Button
                                type="button"
                            ...
                            {registrationFieldErrors.agreeToTerms && (
                                <div className={styles.errorFeedback}>{registrationFieldErrors.agreeToTerms}</div>
                            )}
                        </Form.Group>
